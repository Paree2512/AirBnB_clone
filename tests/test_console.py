...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing promp of HBNB command interpreter"""
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_all_invalid_class_name(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(nonexistent, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("all Julien"))
            self.assertEqual(nonexistent, output.getvalue().strip())
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_without_class_arg(self):
        unknown = "*** Unknown syntax: .update()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(".update()"))
            self.assertEqual(unknown, output.getvalue().strip())
    ...
    def test_update_missing_id_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(empty_string, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_nonexistent_instance(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(no_instance, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("update City 19877"))
            self.assertEqual(no_instance, output.getvalue().strip())
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(attr_missing, output.getvalue().strip())
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(no_value, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testId = output.getvalue().strip()
        testCmd = "update User {} first_name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["User.{}".format(testId)].__dict__
        self.assertEqual("attr_value", test_dict["first_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testId = output.getvalue().strip()
        testCmd = "update State {} name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["State.{}".format(testId)].__dict__
        self.assertEqual("attr_value", test_dict["name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testId = output.getvalue().strip()
        testCmd = "update City {} name 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} number_rooms 'attr_value'".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Place.{}".format(testId)].__dict__
        self.assertEqual("attr_value", test_dict["number_rooms"])

    def test_update_valid_int_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} number_rooms 8".format(testId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Place.{}".format(testId)].__dict__
        self.assertEqual('8', test_dict["number_rooms"])
    ...
    def test_update_valid_float_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        testCmd = "Place.update({}, longitude, 6.4)".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Place.{}".format(tId)].__dict__
        self.assertEqual('6.4', test_dict["longitude"])
